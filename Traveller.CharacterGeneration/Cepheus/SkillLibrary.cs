namespace org.DownesWard.Traveller.CharacterGeneration.Cepheus
{
    public static class SkillLibrary
    {
        ...
        public static Skill NaturalWeapons = new Skill(Resources.Skill_NaturalWeapons, Skill.SkillClass.None, 1);
        ...
        public static Skill VetinaryMedicine = new Skill(Resources.Skill_VetinaryMedicine, Skill.SkillClass.None, 1, Skill.SkillSex.Female);
        ...
        public static Skill GunCombat = new Skill(Resources.Skill_GunCombat, Skill.SkillClass.None, 1)
        {
            Cascade =
            {
                ...
                new Skill(Resources.Skill_EnergyPistol, Skill.SkillClass.Military, 1),
                new Skill(Resources.Skill_EnergyRifle, Skill.SkillClass.Military, 1),
        ...
        public static Skill HeavyWeapons = new Skill(Resources.Skill_HeavyWeapons, Skill.SkillClass.Military, 1);

        public static Skill Gunnery = new Skill(Resources.Skill_Gunnery, Skill.SkillClass.Military, 1)
        {
            Cascade =
            {
                new Skill(Resources.Skill_BayWeapons, Skill.SkillClass.Military, 1),
                HeavyWeapons,
                new Skill(Resources.Skill_Screens, Skill.SkillClass.Military, 1),
                new Skill(Resources.Skill_SpinalMounts, Skill.SkillClass.Military, 1),
                new Skill(Resources.Skill_TurretWeapons, Skill.SkillClass.Military, 1)
            }
        };
