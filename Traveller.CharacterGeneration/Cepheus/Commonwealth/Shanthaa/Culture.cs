...
namespace org.DownesWard.Traveller.CharacterGeneration.Cepheus.Commonwealth.Shanthaa
{
    public class Culture : ICulture
    {
        ...
        public Constants.CultureType Id =>  Constants.CultureType.Cepheus_Shanthaa;
        ...
        public Dictionary<string, CharacterGeneration.Character.Species> Species(Constants.GenerationStyle generationStyle)
        {
            ...
            {
                case Constants.GenerationStyle.Cepheus_Engine:
                    list.Add(Resources.Species_Shanthaa, CharacterGeneration.Character.Species.Shanthaa);
                    break;
            }
